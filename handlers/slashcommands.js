...
//client.api.applications(client.user.id).guilds('guild id').commands.post({data: {     für einen server VVVV ist für mehr als 1 server
	...
	.setDescription(`[<a:GIFHUB:798646097702420511> INVITE ME NOW, thanks](https://discord.com/api/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands)
        ...
        [<:musicium:775854849970798632> INVITE MUSICIUM](https://yakibot.ga/)
        
        [<:ChannelMaster:778404076466602024> INVITE CHANNEL MASTER](https://ch.musicium.eu)
           |   [\`Website\`](https://yakibot.ga/)   |   :heart: Thanks for inviting!`)
	.setFooter(client.user.username + " | Syntax:  <>...must    []...optional", client.user.displayAvatarURL())
	.setAuthor(interaction.member.user.username,  client.user.displayAvatarURL(), "https://yakibot.ga/")
	let totalMembers = client.guilds.cache.reduce((c, g) => c + g.memberCount, 0);
            ...
            const infoembed = new Discord.MessageEmbed()
                ...
                .addFields(
                    ...
                    },
                    {
                        ...
                        value: `**\`Ÿακι ジ#4635\` <@513003402377166909>**`,
                        inline: true,
                    },
                )
                .addField("\u200b", `
            ...
            `)
                .addField("***BOT BY:***", `
            >>> <@513003402377166909> \`Ÿακι ジ#4635\` [\`Website\`](https://yakibot.ga/)
            `)
                .addField("***SUPPORT:***", `
            >>> [\`Server\`](https://discord.gg/JtHCfTMem2) | [\`Musicium - Website\`](https://yakibot.ga/) | [\`Invite\`](https://discord.com/api/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands/)
            `)
            ...
            .setTitle(`Help Menu\nPrefix: \`${prefix}\``)
                ...
                *more coming soon*
                ...
                >>> <@513003402377166909> \`Ÿακι ジ#4635\` [\`Website\`](https://yakibot.ga/) [\`INVITE\`](https://discord.com/api/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands)
                `)
                    .addField("**__Music - Supported sources__**", `
                >>> \`Youtube\`, \`Spotify\`, \`Soundcloud\`, [\`More\`](k), ...
                `)
