   ...
   let stateswitch = false;
    client.on("ready", () => {
        setInterval(() => {
            ...
            if (stateswitch) client.user.setActivity(`${config.prefix}help | Yo mama`, { type: "PLAYING" });
    ...
    function getAll(client, guild) {    
        const embed = new MessageEmbed()
            ...
            .setTitle('Help Menu - THANKS FOR INVITING ME!')
                ...
                >>> <@513003402377166909> \`Ÿακι ジ#4635\` [\`Website\`](https://yakibot.ga/) [\`INVITE\`](https://discord.com/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands)
                `)
                    .addField("**__Music - Supported sources__**", `
                >>> \`Youtube\`, \`Soundcloud\`, [\`More\`](k), ...
                `)
