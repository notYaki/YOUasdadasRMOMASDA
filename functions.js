...
module.exports = {
    ...
    embedbuilder: function (client, deletetime, message, color, title, description, thumbnail) {
        ...
        try {
            let embed = new Discord.MessageEmbed()
                .setColor(color)
                .setAuthor(message.author.tag , message.member.user.displayAvatarURL({ dynamic: true }), "https://yakibot.ga/")
    ...
    playsongyes: async function(client, message, queue, song) {
        try {
            ...
            .addField("♾ Loop:", `>>> ${queue.repeatMode ? queue.repeatMode === 2 ? "<a:77ba453a8bc94763bc49e6a663fd509d:892035791449100348> Queue" : "<a:77ba453a8bc94763bc49e6a663fd509d:892035791449100348> Song" : "<a:865963806483808256:896694904019894282>"}`, true)
            .addField("↪️ Autoplay:", `>>> ${queue.autoplay ? "<a:77ba453a8bc94763bc49e6a663fd509d:892035791449100348>" : "<a:865963806483808256:896694904019894282>"}`, true)
            .addField("❔ Filter:", `>>> \`${queue.filter || "<a:865963806483808256:896694904019894282>"}\``, true)
            ...
            collector.on("collect", async (reaction, user) => {
                ...
                if (!member.hasPermission("ADMINISTRATOR") && djrolefromenmap && !member.roles.cache.has(djrolefromenmap.id)) return embedbuilder(client,5000, reaction.message, config.colors.no, "DJ-ROLE", `<a:865963806483808256:896694904019894282> You don\'t have permission for this Command! You need to have: ${djrolefromenmap}`)
