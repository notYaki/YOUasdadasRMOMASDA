...
module.exports = {
  ...
  .setTitle("YAKI | Service -- Bittmax")
  .setURL("https://yakibot.ga/")
  .setDescription(`
> [YAKI Service](https://discord.gg/terWzJjF7p) made this Bot for us. It is free and also hosted on their sponsor: [Bittmax.de](https://bittmax.de)

> If you use the code: **\`x10\`** their, then you'll get at least 5% off everything!
  
> Check out their [Service-Website](https://YAKI) and their [Discord](https://discord.gg/terWzJjF7p) to get your own Bot too!
...
> It's hosted **24/7**, as already said, thanks to their Sponsor [**Bittmax.de**](https://bittmax.de)!
  ...
  let embed2 = new Discord.MessageEmbed()
    ...
    **What they are offering:**
    ...
    [**__SPONSOR LINK!__**](https://mc-host24.de/donate/yaki)
    `)
