...
async function getAll(client, message) {
    const embed = new MessageEmbed()
        ...
        >>> <@513003402377166909> \`Ÿακι ジ#4635\` [\`Website\`](https://yakibot.ga/) [\`INVITE\`](https://discord.com/api/oauth2/authorize?client_id=902388483568599040&permissions=8&scope=bot%20applications.commands)
        `)
            .addField("**__Music - Supported sources__**", `
        >>> \`Youtube\`, \`Spotify\`, \`Soundcloud\`,  ...
        `)
        .addField("**__TWITTER__**", "https://twitter.com/yonkoyaki\n\n[\`Support Server\`](https://discord.gg/2t8EM3BvPG)")
