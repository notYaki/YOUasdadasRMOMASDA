      ...
      msg.channel.awaitMessages(m=>m.author.id === message.author.id, {max: 1, time: 60000, errors: ["TIME"]}).then(collected=>{
        switch(collected.first().content){
          case "1":
            ...
            .setDescription(`
       **How to setup YAKI's Reaction Role!**
...
`)
    ...
    msg.channel.awaitMessages(m=>m.author.id===message.author.id,{max:1,time:30000,errors:['time']}).then(collected=>{
      switch(collected.first().content.toString()){
        case "1":
          message.guild.channels.create("YAKI-LOGGER", {
            type: 'text',
              permissionOverwrites: [
                {
                  id: message.guild.id,
...
`)
    ...
    msg.channel.awaitMessages(m=>m.author.id===message.author.id,{max:1,time:30000,errors:['time']}).then(collected=>{
      switch(collected.first().content.toString()){
        case "1":
          message.guild.channels.create("YAKI-AI-CHAT", {
            type: 'text',
              permissionOverwrites: [
                {
                  id: message.guild.id,
...
`)
    ...
    msg.channel.awaitMessages(m=>m.author.id===message.author.id,{max:1,time:30000,errors:['time']}).then(collected=>{
      switch(collected.first().content.toString()){
        case "1":
          message.guild.channels.create("YAKI-Counter-CHAT", {
            type: 'text',
              permissionOverwrites: [
                {
                  id: message.guild.id,
