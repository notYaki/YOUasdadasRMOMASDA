  ...
  run: async (client, message, args) => {
    ...
    const embed = new Discord.MessageEmbed()
        .setAuthor(
            ...
            config.AVATARURL, "https://discord.com/api/oauth2/authorize?client_id=902388483568599040&permissions=8&scope=bot%20applications.commands"
        )
    ...
    `) .addField("***SUPPORT:***", `
    >>> [\`Server\`](https://discord.gg/JtHCfTMem2) | [\`Yaki - Website\`](https://yakibot.ga/) | [\`Invite\`](https://discord.com/oauth2/authorize?client_id=789845410998779904&permissions=8&scope=bot%20applications.commands/)
