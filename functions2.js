    ...
    playsongyes: async function(client, message, queue, song) {
        try {
            ...
            collector.on("collect", async (reaction, user) => {
                ...
                if (!member.hasPermission("ADMINISTRATOR") && djrolefromenmap && !member.roles.cache.has(djrolefromenmap.id)) return embedbuilder(5000, reaction.message, config.colors.no, "DJ-ROLE", `<a:865963806483808256:896694904019894282> You don\'t have permission for this Command! You need to have: ${djrolefromenmap}`)
